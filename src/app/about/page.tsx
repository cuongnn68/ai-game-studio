export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">About AI Game Studio</h1>
      <div className="space-y-4">
        <p className="text-lg leading-relaxed">
          Welcome to AI Game Studio, where creativity meets artificial
          intelligence to create unique gaming experiences.
        </p>
        <p className="text-lg leading-relaxed">
